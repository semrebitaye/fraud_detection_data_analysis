...
def load_datasets():
    ...
    ip_country = pd.read_csv('/home/semre/fraud_detection_data_analysis/data/IpAddress_to_Country.csv')
    credit_card = pd.read_csv('/home/semre/fraud_detection_data_analysis/data/creditcard.csv')
